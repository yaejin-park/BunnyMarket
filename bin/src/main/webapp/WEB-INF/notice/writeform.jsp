...
<div class="inner">
	<form action="insert" method="post" enctype="multipart/form-data">
		<button type="button" onclick="location.href='list'" class="btn-list nbtn">목록</button>
		<button type="submit" class="btn-default nbtn">저장</button>

		<table class="wtable">
			<tr>
				<th><label>제목</label><br> <input type="text"
					required="required" placeholder="제목을 입력하세요" name="title"></th>
			</tr>
			<tr>
