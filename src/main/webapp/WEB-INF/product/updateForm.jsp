...
<div class="write-form product-div">
	<div class="inner">
		...
		<div class="group">
			...
			<div class="child img-upload">
				...
				<div class="preview-area">
					<input type="hidden" name="photo" value="${dto.uploadfile}">
		...
		<div class="group">
			<div class="price child tit">금액<span class="must">*</span>
			</div>
			<div class="child">
		...
		<div class="group">
			...
			<div class="child">
				<textarea class="textinput" name="content" placeholder="상품설명을 입력해주세요" required="required">${dto.content}</textarea>
			</div>
		</div>

		<div class="group">
			<div class="btn-wrap">
				<button type="button" class="btn-list update-btn">수정하기</button>
