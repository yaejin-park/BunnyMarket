...
<div class="inner">
	<div class="term">
		<span class="strong">제1조 (목적)</span></br>
		본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)이 주식회사 바니마켓(이하 “회사”라고 합니다)가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리・의무 및 책임사항을 규정함을 목적으로 합니다.
		</br></br>
		
		<span class="strong">제2조 (약관의 효력 및 변경)</span></br>
		<ol>
		...
		<span class="strong">제3조 (약관 외 준칙)</span></br>
		본 약관에 규정되지 않은 사항에 대해서는 위치정보의 보호 및 이용 등에 관한 법률(이하 “위치정보법”이라고 합니다), 전기통신사업법, 정보통신망 이용촉진 및 보호 등에 관한 법률(이하 “정보통신망법”이라고 합니다), 개인정보보호법 등 관련법령 또는 회사가 정한 서비스의 운영정책 및 규칙 등(이하 “세부지침”이라고 합니다)의 규정에 따릅니다.</br>
		</br></br>
		
		<span class="strong">제4조 (서비스의 가입)</span></br>
		<ol>
			<li>본회사는 아래와 같은 경우에는 여러분의 바니마켓 계정 생성을 유보할 수 있습니다.</li>
				<ul>
		...
		<span class="strong">제5조 (서비스의 해지)</span></br>
		회원이 서비스 이용을 해지하고자 할 경우 회원은 회사가 정한 절차(서비스 홈페이지 등을 통해 공지합니다)를 통해 서비스 해지를 신청할 수 있으며, 회사는 법령이 정하는 바에 따라 신속히 처리합니다.</br>
		</br></br>
		
		<span class="strong">제6조 (서비스의 내용)</span></br>
		<ol>
			...
			<li>회사가 제공하는 서비스의 종류, 세부 내용, 이용 요금은 아래와 같습니다.</br>
				-종류 : 동네 커뮤니티 서비스</br>
				-서비스명 : 바니마켓</br>
				-설명 : 내동네를 인증하고 주변 이웃과 중고물품을 거래하거나 동네 정보를 공유하는 서비스</br>
				-위치정보 이용 목적: 내동네 인증</br>
				-이용 요금 : 무료</li>
		</ol>
		</br></br>
		
		<span class="strong">제7조 (서비스 이용요금)</span></br>
		<ol>
		...
		<span class="strong">제8조 (서비스의 이용제한 및 중지)</span></br>
		<ol>
			<li>회사는 아래 각 호의 경우에는 회원의 서비스 이용을 제한하거나 중지시킬 수 있습니다</br>
				...
				-기타 중대한 사유로 인하여 회사가 서비스 제공을 지속하는 것이 부적당하다고 인정하는 경우</li>
			<li>회사는 전항의 규정에 의하여 서비스의 이용을 제한하거나 중지한 때에는 그 사유 및 제한기간 등을 회원에게 알려야 합니다.</li>
		</ol>
		</br></br>
		
		<span class="strong">제9조 (서비스내용변경 통지 등)</span></br>
		<ol>
		...
		<span class="strong">제10조 (개인위치정보의 이용 또는 제공)</span></br>
		<ol>
			...
			<li>회사는 개인위치정보주체의 동의 없이 개인위치정보를 제3자에게 제공하지 아니하며, 제3자 제공 서비스를 제공하는 경우에는 제공 받는자 및 제공목적을 사전에 개인위치정보주체에게 고지하고 동의를 받습니다. 다만, 다음의 경우는 예외로 하고 있습니다.</br>
				-법령의 규정에 의거하거나 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우</li>
			<li>회사는 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원에게 제공받는 자, 제공 일시 및 제공목적을 즉시 통보합니다. 단, 아래 각 호의 1에 해당하는 경우에는 회원이 미리 특정하여 지정한 통신 단말장치 또는 전자우편주소로 통보합니다.</br>
				-개인위치정보를 수집한 당해 통신단말장치가 문자, 음성 또는 영상의 수신기능을 갖추지 아니한 경우</br>
				-회원이 온라인 게시 등의 방법으로 통보할 것을 미리 요청한 경우</li>
		</ol>
		</br></br>
		
		<span class="strong">제12조 (법정대리인의 권리)</span></br>
		<ol>
			...
			<li>회사는 14세 미만의 아동의 개인위치정보 또는 위치정보 이용, 제공사실 확인자료를 이용약관에 명시 또는 고지한 범위를 넘어 이용하거나 제3자에게 제공하고자 하는 경우에는 14세 미만의 아동과 그 법정대리인의 동의를 받아야 합니다. 단, 아래의 경우는 제외합니다.</br>
				-위치정보 및 위치기반서비스 제공에 따른 요금정산을 위하여 위치정보 이용, 제공사실 확인자료가 필요한 경우</br>
				-통계작성, 학술연구 또는 시장조사를 위하여 특정 개인을 알아볼 수 없는 형태로 가공하여 제공하는 경우</li>
		</ol>
		<span>제13조 (8세 이하의 아동 등의 보호의무자의 권리)</span></br>
		<ol>
			<li>회사는 14세 미만의 아동의 개인위치정보 또는 위치정보 이용, 제공사실 확인자료를 이용약관에 명시 또는 고지한 범위를 넘어 이용하거나 제3자에게 제공하고자 하는 경우에는 14세 미만의 아동과 그 법정대리인의 동의를 받아야 합니다. 단, 아래의 경우는 제외합니다.</li>
				<ul>
					<li>8세 이하의 아동</li>
					<li>피성년후견인</li>
			...
			<li>전항의 규정에 따른 8세 이하 아동 등의 보호의무자는 해당 아동을 사실상 보호하는 자로서 다음 각 호에 해당하는 자를 말합니다.</li>
				<ul>
		...
		<span class="strong">14조 (양도금지)</span></br>
		회원의 서비스 받을 권리는 이를 양도 내지 증여하거나 담보제공 등의 목적으로 처분할 수 없습니다.
		</br></br>
		
		<span class="strong">제15조 (손해배상)</span></br>
		...
		<span class="strong">제16조 (면책)</span></br>
		<ol>
			<li>회사는 다음 각 호의 경우로 서비스를 제공할 수 없는 경우 이로 인하여 회원에게 발생한 손해에 대해서는 책임을 부담하지 않습니다.</br>
				-천재지변 또는 이에 준하는 불가항력의 상태가 있는 경우</br>
				-서비스 제공을 위하여 회사와 서비스 제휴계약을 체결한 제3자의 고의적인 서비스 방해가 있는 경우</br>
				-회원의 귀책사유로 서비스 이용에 장애가 있는 경우4) 제1호 내지 제3호를 제외한 기타 회사의 고의ㆍ과실이 없는 사유로 인한 경우</li>
			<li>회사는 서비스 및 서비스에 게재된 정보, 자료, 사실의 신뢰도, 정확성 등에 대해서는 보증을 하지 않으며 이로 인해 발생한 회원의 손해에 대하여는 책임을 부담하지 아니합니다.</li>
		</ol>
		<span class="strong">제17조 (분쟁의 조정 및 기타)</span></br>
		<ol>
